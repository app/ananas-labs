...
public:
	...
	* \_en \ru
	*	\brief Перечисление поддерживаемых типов баз данных.
	*	По состоянию на 20070630 реализована поддержка для mysql и postgresql
	* \_ru
	*/
	enum dbServer
	{
	...
	*	metadata object 
	* \_en \ru 
	*	\brief Объект для работы с метаданными бизнес схемы Ананаса.
	* \_ru
	*/
	aCfg cfg;
