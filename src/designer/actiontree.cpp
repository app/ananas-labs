/****************************************************************************
** $Id: actiontree.cpp,v 1.25 2008/06/09 11:47:59 app Exp $
**
...
aActionTreeView::ContextMenu()
{
	...
	ContextMenuAdd( m );
	m->insertItem( QObject::tr("New &Group"),  this, SLOT( itemNewGroup() ), CTRL+Key_G );
	m->insertItem( QObject::tr("New &Action"),  this, SLOT( itemNewAction() ), CTRL+Key_A );
