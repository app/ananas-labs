/****************************************************************************
** $Id: wdbtable.h,v 1.60 2008/04/12 18:05:35 app Exp $
**
...
/**
 * \en	Class for drag&drop elements of catalogs. \_en
 * \ru 	
 * 	\brief Класс для реализации перетаскивания мышкой элементов справочников между группами.
 * \_ru
 */
class aObjectDrag : public QDragObject
{
    Q_OBJECT
public:
    aObjectDrag(aObject * obj, QWidget * dragSource);
    ~aObjectDrag();
    
    virtual void	setObject(aObject* obj);
    aObject* 		object() { return fObj; };
